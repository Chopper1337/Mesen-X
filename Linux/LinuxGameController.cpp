...
bool LinuxGameController::IsButtonPressed(int buttonNumber)
{
	switch(buttonNumber) {
		...
		case 30: return CheckAxis(ABS_HAT1X, true) || (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_RIGHT) == 1);
		case 31: return CheckAxis(ABS_HAT1X, false)|| (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_LEFT) == 1);		;		
		case 32: return CheckAxis(ABS_HAT1Y, true) || (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_DOWN) == 1);
		case 33: return CheckAxis(ABS_HAT1Y, false)|| (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_UP) == 1);				;
		case 34: return CheckAxis(ABS_HAT2X, true) || (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_RIGHT) == 1);
		case 35: return CheckAxis(ABS_HAT2X, false)|| (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_LEFT) == 1);		;		
		case 36: return CheckAxis(ABS_HAT2Y, true) || (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_DOWN) == 1);
		case 37: return CheckAxis(ABS_HAT2Y, false)|| (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_UP) == 1);				;
		case 38: return CheckAxis(ABS_HAT3X, true) || (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_RIGHT) == 1);
		case 39: return CheckAxis(ABS_HAT3X, false)|| (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_LEFT) == 1);		;		
		case 40: return CheckAxis(ABS_HAT3Y, true) || (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_DOWN) == 1);
		case 41: return CheckAxis(ABS_HAT3Y, false)|| (libevdev_get_event_value(_device, EV_KEY, BTN_DPAD_UP) == 1);				;
